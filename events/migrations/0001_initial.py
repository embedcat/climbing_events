    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='wallet', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Route',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applied_num', models.IntegerField(blank=True, default=0, null=True)),
                ('max_applied_num', models.IntegerField(blank=True, default=0, null=True)),
        ...
        migrations.AddField(
            model_name='event',
            name='wallet',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='event', to='events.wallet'),
        ),
    ]
